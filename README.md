...
_Да кажем, че имаме:
Обект A = кошница с ябълки и круши. Стрелка () → A е като да накараме детето да посочи едно нещо от кошницата. Тъй като детето може да прави само едно движение (вдига пръста), единственото, което определя стрелката, е кое нещо е насочено от пръста. Тоест, ако има 5 плода в кошницата, има 5 възможни стрелки () → A: показалецът сочи първото, второто, третото, четвъртото, петото._
...
к**() → A** е функция, която избира точно една стойност от A.

**pickFirst :: () -> Int**

**pickFirst () = 42**

Такива функции има толкова, колкото стойности има в A.Ето как терминалният обект се превръща в „сонда", която проверява какъв е A.
...
Когато в една категория вземем двa произволни обект, всички стрелки между тях образуват **множество**. Точно затова е добре човек да има поне базова представа от теория на множествата — тя подпомага интуицията ни за категориите.
